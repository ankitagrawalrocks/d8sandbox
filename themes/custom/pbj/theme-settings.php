 ...
 */
function pbj_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['pbj_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('pbj sample setting'),
  '#default_value' => theme_get_setting('pbj_example'),
