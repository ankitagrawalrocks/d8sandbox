...
/**
 * @file
 * Contains Drupal\cron_queuing\Plugin\QueueWorker\WelcomeMailSenderBase.php
 */
...
class WelcomeMailSender extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    $module = 'cron_queuing'; // ideally should be a config parameter but don't know how. Configuration is empty by design...
    $key = 'create_article';
    ...
    $params['message'] = $this->t('Hi :login man, this is your new registration!', [':login' => $login])->__toString();
